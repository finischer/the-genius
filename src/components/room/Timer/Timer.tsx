        ...
        <AnimatePresence>
            {timerState.isActive &&
                <motion.div {...animations.fadeInOut}>
                    <Flex
                        h="5rem" miw="5rem" bg="brand" p="0 1rem" justify="center" align="center" sx={(theme) => ({ borderRadius: theme.radius.sm, boxShadow: theme.shadows.xl })}>
                        <Text size="2.25rem" color={secondsColor}>
